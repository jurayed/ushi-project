...
async function addMessage(conversationId, senderId, messageText) {
  try {
    const result = await pool.query(
      'INSERT INTO conversation_messages (conversation_id, sender_id, message_text) VALUES ($1, $2, $3) RETURNING *',
